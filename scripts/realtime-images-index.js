...
var container, d3, imagesloaded, imgload;
...
container.selectAll(".thumbnail").classed("loading", true);

imgload = imagesloaded(container.node());

imgload.on("progress", function(instance, image) {
  return d3.select(image.img.parentNode).classed("loading", false);
});


},{"d3":2,"imagesloaded":3}],2:[function(require,module,exports){
!function() {
  var d3 = {
    version: "3.4.9"
  };
